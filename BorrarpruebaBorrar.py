...
textos = ['Hace que todos en el mundo mueran de hambre de mierda y hacen desaparecer el intelecto.',
    'más',
    'Quitando recuerdos y haciéndolos vagar por las calles sin pensar.']
